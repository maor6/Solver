...
int main() {
    ...
    // cout << solve(2*x-4.0 == 10.0) << endl;   // xvalue == 7

    // ComplexVariable y;
    // std::complex<double> yvalue = solve(2*y-4.0 == 10);
    // cout << yvalue << endl;  // 7+0i  (can be in any other format)
    // cout << solve((y*2.0) == 16i) << endl; 
    // // cout << " ar is :"<<y.re._a << endl;
    // //     cout << " br is :"<<y.re._b << endl;
    // //     cout << " cr is :"<<y.re._c << endl;
