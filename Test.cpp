...
TEST_CASE("test for operators + and ^") {
    ...
    CHECK((solve(45 == (x^2)+2.112+67.45) == 5.5170 || solve(45 == (x^2)+2.112+67.45) == -5.5170));
}

TEST_CASE("test for operators - and *") {
    RealVariable x;
    CHECK(solve(x*2-6 == 2) == 4);
    CHECK(solve(10-x*2 == 1) == 4.5);
    CHECK(solve(9-8-x*3.66 == 14*x) == 0.0566);
    CHECK(solve(3-9.2 == 21.5-x*5) == 5.54);
    CHECK(solve(41*x-20 == 8) == 0.6829);
    CHECK(solve(25-x*45 == -19.11) == 0.9802);
    CHECK(solve(9 == -5.5-67.87*x) == -0.2136);
    CHECK(solve(45 == -2.112*x-67.45) == -53.2433);
}
...
TEST_CASE("test for operators / and ^") {
    RealVariable x;
    CHECK((solve((x^2)/1 == 2) == 1.4142 || solve((x^2)/1 == 2) == -1.4142));
    CHECK((solve(10/(x^2) == 1/10) == 10 || solve(10/(x^2) == 1/10) == -10));
    CHECK((solve(9/8/(x^2) == 14) == 0.2834 || solve(9/8/(x^2) == 14) == -0.2834));
    CHECK((solve(3/9.2 == 21.5/(x^2)) == 8.1199 || solve(3/9.2 == 21.5/(x^2)) == -8.1199));
    CHECK((solve((x^2)/20 == 8/21) == 2.7602 || solve((x^2)/20 == 8/21) == -2.7602));
    //CHECK(solve(19.11 == 25.0/(x^2.0)) == );
    CHECK((solve(9/0.5 == 5.5/(x^2)/3) == 1.1437 || solve(9/0.5 == 5.5/(x^2)/3) == -1.1437));
...
TEST_CASE("test for all operators ") {
    ...
    CHECK((solve(10*(x^2)+3*x == -10) == 0.8611 || solve(10*x^2+3*x == -10) == -1.1611));
    CHECK((solve(9+8*(x^2)-3.7*x == 14) == 1.0549 || solve(9+8*x^2-3.7*x == 14) == -0.5924));
    CHECK((solve(3/9.2*x+43 == 21.5/(x^2)) == 70.3159 || solve(3/9.2*x+43 == 21.5/(x^2)) == -4.3826));
    CHECK((solve((x^2)/20+17.77 == 21-6.99) == 23.0034 || solve((x^2)/20+17.77 == 21-6.99) == -23.0034));
